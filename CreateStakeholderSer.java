...
public class CreateStakeholderSer
{
    ...
    public void writeToFile()
    {
        try
        {
            output.writeObject(new Customer(
                    "C150", "Luke", "Atmyass", 
                    "Bellville", "1981-01-27", 1520.50, false));
            
            output.writeObject(new Supplier(
                    "S270", "Grand Theft Auto", "Toyota", "Mid-size sedan"));
            
            output.writeObject(new Customer(
                    "C130", "Stu", "Padassol", 
                    "Sea Point", "1987-05-18", 645.25, true));
            ...
            output.writeObject(new Customer(
                    "C100", "Mike", "Rohsopht", 
                    "Bellville", "1993-01-24", 975.10, true));
            
            output.writeObject(new Customer(
                    "C300", "Ivana.B", "Withew", 
                    "Langa", "1998-07-16", 1190.50, false));
            ...
            output.writeObject(new Customer(
                    "C250", "Eileen", "Sideways", 
                    "Nyanga", "1999-11-27", 190.85, true));
            
            output.writeObject(new Customer(
                    "C260", "Ima", "Stewpidas", 
                    "Atlantis", "2001-01-27", 1890.70, true));
        }//end try
